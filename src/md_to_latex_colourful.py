...
class md_to_latex_generator(abstract_generator):
    ...
    def __init__(self, filename: str, tex_template = 'cheatsheet_template_colourful.tex'):
        ...
        latex_file=filename[0:filename.lower().rfind('.md')] + '-colourful-md.tex'
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Usage: gen_cs <md file> [colourful_tex_template]")
        sys.exit(1)
