...
\begin{tikzpicture}
  ...
  \begin{center}
    \Huge{\underline{Boost Filesystem}}
  \end{center}
  ...
  \begin{multicols}{3}
    ...
    \begin{keys}{}
      namespace            & \texttt{boost::filesystem} \\
      Text                 & \texttt{Command} \\
      Text                 & \texttt{Command} \\
      Text                 & \texttt{Command} \\
      Text                 & \texttt{Command} \\
    ...
    \centering\section{path}

    \begin{keys}{Decomposition}
      /foo/bar.txt = bar.txt   & \texttt{path filename()} \\
      Text                     & \texttt{Command} \\
      Text                     & \texttt{Command} \\
      Text                     & \texttt{Command} \\
      Text                     & \texttt{Command} \\
    ...
    \centering\section{Fonctions}

    \begin{keys}{Something}
      Vérifie si path est un répertoire                 & \texttt{is\_directory} \\
      Vérifie si path est un répertoire                 & \texttt{is\_regular\_file} \\
      Text                 & \texttt{Command} \\
      Text                 & \texttt{Command} \\
      Text                 & \texttt{Command} \\
      Text                 & \texttt{Command} \\
