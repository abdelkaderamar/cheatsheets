...
\begin{tikzpicture}
  ...
  \begin{multicols}{2}
    ...
    \begin{keys}{Basic commands}
      ...
      cmake version requirement          & \texttt{cmake_minimum_required( VERSION 2.8.7 )} \\
    \end{keys}
   ...
   \begin{keys}{Files names}
     ...
     \texttt{get_filename_component(CPP\_EXE ${CPP\_FILE} NAME_WE )}
   \end{keys}
    ...
    \begin{keys}{Compilateur}
      ...
      \texttt{set(CMAKE_CXX_STANDARD 14)
